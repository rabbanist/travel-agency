                                        ...
                                        @foreach($packages as $package)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.package_itinerary',$package->id) }}" class="btn btn-success">Itinerary</a>
                                                    <a href="{{ route('admin.package_photo',$package->id) }}" class="btn btn-success">Photo</a>
